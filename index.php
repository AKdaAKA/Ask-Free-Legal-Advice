...
“India has acquired a reputation of an expensive legal system. In part, this is because of delays but there is also a question of affordability of fees. The idea is that a relatively poor person cannot reach the doors of justice for a fair hearing only because of financial or similar constraints while it is in our constitutional values and republic ethics. It is a burden on our collective conscience."<br>  President Ram Nath Kovind, on November 25, 2017 - The National Law Day</p>
     ...
     <div class="row">
        <div class="col span-1-of-4 box">
            ...
            <h4>who is this?</h4>
				<p>A retired District Judge and family, driven by the belief that quality legal guidance shouldn't depend on how much you can afford. We built this platform to give everyone in India a fair shot at understanding their rights.</p>
        </div>  
        ...
        <div class="col span-1-of-4 box">
           ...
           <h4>how it works?</h4>
            <p>Simply submit your inquiry through our Google Form and we'll review it and email you back with guidance. It's that easy &mdash; free, confidential, and no strings attached.</p>
        </div> 
  ...
  <section class="advice-fields" id="advice-fields">
...
</section><section class="section-form js--section-form" id="form">
   <a name="askform"></a>
   <div class="row">
   ...
   <div class="row">
        <div class="inquiry-card">
            ...
            <p>
                We have simplified our inquiry submission process! To submit your details and legal queries, please click the button below to fill out our secure Google Form. We will review your inquiry and get back to you.
            </p>
            <a href="https://forms.gle/gR5tHBqxkB8hTs887" target="_blank" class="btn-google-form">Submit your inquiries!</a>
        </div>
   </div>
</section>
...
<div class="col span-1-of-3 box">
    ...
    <div class="row">
        <p>
            Ask Free Legal Advice India &copy; 2025. All rights reserved.
        </p>
    </div>
</footer>
