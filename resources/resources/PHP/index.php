...
<meta name="description" content="Askfreelegal advice offers free legal advice with a mission to help people who cannot afford present day costly legal services.">
...
<link href="http://fonts.googleapis.com/css?family=Lato:100,300,400,300italic" rel="stylesheet" type="text/css">
    <title>Askfreelegaladvice</title>
...
<body>
 <header>
     ...
     <div class="law-text-box">
          <h1>Ask Free Legal Advice.</h1>
         <h2> Free advice on your legal problems(India).</h2>
         <a class="btn js--scroll-to-form" href="#form">Give me advice</a>
     </div>
</header>
...
“India has acquired a reputation of an expensive legal system. In part, this is because of delays but there is also a question of affordability of fees. The idea is that a relatively poor person cannot reach the doors of justice for a fair hearing only because of financial or similar constraints while it is in our constitutional values and republic ethics. It is a burden on our collective conscience."<br>  President Ram Nath Kovind, on November 25, 2017 - The National Law Day</p>
     ...
     <div class="row">
         ...
         <div class="col span-1-of-4 box">
           ...
           <h4>Aim and scope</h4>
            <p>Our aim is to help people in need of legal advice for their problems. <br> Drafting documents or giving citation of judgments is beyond the scope of this website.
            </p>   
         </div>
         <div class="col span-1-of-4 box">
...
<section class="section-form js--section-form">
        ...
        <div class="row">
        <form method="post" action="mailer.php" class="query-form">
    ...
    <div class="row">
          ...
          <div class="col span-2-of-3">
              <input type="text" name="name" id="name" placeholder="last name - first name" required>
            </div>        
    </div>
   <div class="row">
        <div class="col span-1-of-3">
   ...
   <div class="row">
        ...
        <div class="col span-2-of-3">
            <textarea name="query" id="query" placeholder="Fill in your query here" required></textarea>
        </div>
   </div>
   <div class="row">
        <div class="col span-1-of-3">
...
<section class="legalupdates" id="legal-updates">
		<div class="row">
		<h3>Legal Updates</h3>
		</div>
<div class="row">
<div class="col span-1-of-3 box">				
        ...
        <img src="resources/img/landRecords.jpg" alt="land-records">
        <h4>Khata/Patta proves title?</h4>
        <p><b>The said contention is legally misconceived.</b></p>
        <p>In a civil appeal, The Hon'ble Supreme Court of India observed as follows:</p>
        <p>The said contention is legally misconceived since entries in  the  revenue  records  do  not  confer  title  to  a  property,  nor do  they  have  any  presumptive  value  on  the  title.  They  only enable  the  person  in  whose  favour  mutation  is recorded,  to Pay the land revenue in respect of the land in question.</p>
        <p>As  a  consequence,  merely  because  Mangal Kumhar’s name  was  recorded  in  the  Survey Settlement  of  1964  as  a Recorded tenant in the suit property,it would not make him The sole and exclusive owner of the suit property.<br><br>
        <i>Civil Appeal No(s). 5919/2011
        prahalad pradhan and others vs sonu kumar and others (Hon'ble Indu Malhotra and Hon'ble Krishna Murari,JJ.) Date : 16-10-2019.</i></p>  
</div>
